...
/**
 * Tests Library loader architecture methods This test requires that racob.jar
 * be compiled and added to the classpath. You will need to refresh the release
 * directory so that eclipse knows about racob.jar. Otherwise you will get a
...
public class LibraryLoaderTest extends TestCase {
	...
	public void testJacobDllNameSystemProperty() {
		...
		System.setProperty(LibraryLoader.RACOB_DLL_NAME, "xxx");
		try {
